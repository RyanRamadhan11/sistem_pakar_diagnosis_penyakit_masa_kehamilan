...
$pengguna = pengguna("SELECT * FROM pasien WHERE id_pasien = $id_pasien")[0];
...
if (isset($_POST["button"])) {
    ...
    if (update_pengguna($_POST) > 0) {
        echo " <script>
					alert('Data Pengguna atau Pasien Berhasil Diubah');
					document.location.href ='../pengguna.php';
			   </script>
			 ";
    } else {
        echo " <script>
					alert('Data Pengguna atau Pasien Gagal Diubah');
			   </script>
			 ";
    }
}
                            ...
                            <h2 style="margin: 10px 0px 10px 10px; ">Sistem Pakar</h2>
                                <nav>
                                    <ol class="breadcrumb mb-4 " style="margin-left: 10px;">
                                        ...
                                        <li class="breadcrumb-item active"><a style="text-decoration: none; color: black;" href="../pengguna.php">Data Pasien</a></li>
                                ...
                                <div class="card-body">
                                    <form action="" method="post">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" value="<?php echo $pengguna["nama_pasien"]; ?>" id="nama_pasien" aria-describedby="nama_pasien" name="nama_pasien" required>
                                        </div>
                                        <div class="mb-3">
                                            <label for="usia" class="form-label">Usia</label>
                                            <input type="text" class="form-control" value="<?php echo $pengguna["usia"]; ?>" id="usia" aria-describedby="usia" name="usia" required>
                                        </div>
                                        <div class="mb-3">
                                            <label for="email" class="form-label">Email</label>
                                            <input type="email" class="form-control" value="<?php echo $pengguna["email"]; ?>" id="email" aria-describedby="email" name="email" required>
                                        </div>
                                        <div class="mb-3">
                                            <label for="alamat" class="form-label">Alamat</label>
                                            <div class="form-floating">
                                                <textarea class="form-control" id="alamat" name="alamat" style="height: 100px" required><?php echo $pengguna["alamat"]; ?></textarea>
                                            </div>
                                        </div>
