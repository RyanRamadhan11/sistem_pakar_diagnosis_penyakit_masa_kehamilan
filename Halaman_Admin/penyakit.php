                        ...
                        <div class="card mb-4">
                            ...
                            <div class="mt-4" style="width:550px; margin-left:18px;">
                                <a class="btn btn-sm" title="Tambah Testimoni" style="background-color: blue; color: white; font-weight: bold; border-radius: 8px;"
                                    href="penyakit/tambah-penyakit.php">
                                    <i class="fa-solid fa-folder-plus" style="margin-right:4;"></i> Add Penyakit
                                </a>
                            </div>
                                    ...
                                    <tbody>
                                        <?php foreach ($result as $row) : ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="penyakit/ubah-penyakit.php?kd_penyakit=<?php echo $row["kd_penyakit"]; ?>" 
                                                    class="btn btn-warning btn-sm"><i class="fa-solid fa-pen-to-square"></i></a>
                                                </td>
                                                <td>
                                                    <a href="penyakit/hapus-penyakit.php?kd_penyakit=<?php echo $row["kd_penyakit"]; ?>" 
                                                    onclick="return confirm('Apakah Anda Yakin Ingin Menghapus Data Penyakit Yang Dipilih?');" 
