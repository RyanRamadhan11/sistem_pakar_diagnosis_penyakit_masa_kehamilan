...
if (isset($_POST["button"])) {
    ...
    if (tambah_gejala($_POST) > 0) {
        ...
        echo "
            <script>
            alert('Data Gejala Gagal Ditambahkan');
            document.location.href = '../gejala.php';
            </script>
        ";
    }
                            ...
                            <h2 style="margin: 10px 0px 10px 10px; ">Sistem Pakar</h2>
                                <nav>
                                    <ol class="breadcrumb mb-4 " style="margin-left: 10px;">
                                        ...
                                        <li class="breadcrumb-item active"><a style="text-decoration: none; color: black;" href="../gejala.php">Data Gejala</a></li>
                                ...
                                <div class="card-body">
                                    <form action="" method="post">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="kd_gejala" aria-describedby="kd_gejala" name="kd_gejala" required>
                                        </div>
                                        <div class="mb-3">
                                            <label for="nama_gejala" class="form-label">Nama Gejala</label>
                                            <input type="text" class="form-control" id="nama_gejala" aria-describedby="namagejala" name="nama_gejala" required>
                                        </div>
