...
$result = query("SELECT * FROM gejala");
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="mt-4" style="width:550px; margin-left:18px;">
                                ...
                                <a class="btn btn-sm" title="Tambah Testimoni" style="background-color: blue; color: white; font-weight: bold; border-radius: 8px;"
                                    href="gejala/tambah-gejala.php">
                                    <i class="fa-solid fa-folder-plus" style="margin-right:4;"></i> Add Gejala
                                </a>
                            </div>
                                    ...
                                    <tbody>
                                        <?php foreach ($result as $row) : ?>
                                            <tr>
                                                ...
                                                <td><a href="gejala/ubah-gejala.php?kd_gejala=<?php echo $row["kd_gejala"]; ?>" 
                                                class="btn btn-warning btn-sm"><i class="fa-solid fa-pen-to-square"></i></a></td>
                                                <td><a href="gejala/hapus-gejala.php?kd_gejala=<?php echo $row["kd_gejala"]; ?>" 
                                                onclick="return confirm('Apakah Anda Yakin Ingin Menghapus Data Gejala Yang Dipilih?');" 
