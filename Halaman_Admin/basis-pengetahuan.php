...
require 'pengetahuan/controllers-pengetahuan.php';

//ambil data dari table gejala
$result = pengetahuan("SELECT * FROM basis_pengetahuan 
                    INNER JOIN penyakit ON basis_pengetahuan.kd_penyakit = penyakit.kd_penyakit 
                    INNER JOIN gejala ON basis_pengetahuan.kd_gejala = gejala.kd_gejala");
?>
                        ...
                        <div class="card mb-4">
                            <h2 style="margin: 10px 0px 10px 10px; ">Sistem Pakar</h2>
                                <nav>
                                    <ol class="breadcrumb mb-4 " style="margin-left: 10px;">
                                        ...
                                        <li class="breadcrumb-item active">Data Basis Pengetahuan</li>
                                    </ol>
                                </nav>
                            ...
                            <div class="mt-4" style="width:550px; margin-left:18px;">
                                <a class="btn btn-sm" title="Tambah Testimoni" style="background-color: blue; color: white; font-weight: bold; border-radius: 8px;"
                                    href="pengetahuan/tambah-pengetahuan.php">
                                    <i class="fa-solid fa-folder-plus" style="margin-right:4;"></i> Add Pengetahuan
                                </a>
                            </div>
                                    ...
                                    <tbody>
                                        <?php foreach ($result as $row) : ?>
                                            <tr>
                                                ...
                                                <td><a href="pengetahuan/ubah-pengetahuan.php?id_pengetahuan=<?php echo $row["id_pengetahuan"]; ?>" 
                                                class="btn btn-warning btn-sm"><i class="fa-solid fa-pen-to-square"></i></a></td>
                                                <td><a href="pengetahuan/hapus-pengetahuan.php?id_pengetahuan=<?php echo $row["id_pengetahuan"]; ?>" 
                                                onclick="return confirm('Apakah Anda Yakin Ingin Menghapus Data Basis Pengetahuan Yang Dipilih?');" 
