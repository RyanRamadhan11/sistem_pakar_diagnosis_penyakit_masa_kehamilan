...
$penyakit = penyakit("SELECT * FROM penyakit WHERE kd_penyakit = '" . $kd_penyakit . "'")[0];
                                    ...
                                    <div class="card-body">
                                        <form action="" method="POST">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" value="<?php echo $penyakit["kd_penyakit"]; ?>" id="name" aria-describedby="name" name="kd_penyakit" readonly>
                                            </div>
                                            <div class="mb-3">
                                                <label for="namagejala" class="form-label">Nama Penyakit</label>
                                                <input type="text" class="form-control" id="namagejala" value="<?php echo $penyakit["nama_penyakit"]; ?>" aria-describedby="namagejala" name="nama_penyakit" required>
                                            </div>
                                            <div class="mb-3">
                                                <label for="penjelasan" class="form-label">Penjelasan Penyakit</label>
                                                <div class="form-floating">
                                                    <textarea class="form-control" placeholder="Leave a comment here" id="penjelasan" style="height: 100px" name="penjelasan" required><?php echo $penyakit["penjelasan"]; ?> </textarea>
                                                </div>
                                            </div>
                                            <div class="mb-3">
                                                <label for="solusi" class="form-label">Solusi</label>
                                                <div class="form-floating">
                                                    <textarea class="form-control" placeholder="Leave a comment here" id="solusi" style="height: 100px" name="solusi" required><?php echo $penyakit["solusi"]; ?></textarea>
                                                </div>
                                            </div>
                                            <button type="submit" class="btn" style="background-color: #053038; color: white; font-weight: bold;" name="button">Simpan</button>
                                        </form>
                                    </div>
                                </div>
                            </div>
