...
require '../penyakit/controllers-penyakit.php';
require '../gejala/controllers-gejala.php';

//ambil data di url 
$id_pengetahuan = $_GET['id_pengetahuan'];

//query menampilkan data
$result = penyakit("SELECT * FROM penyakit");
$result_gejala = query("SELECT * FROM gejala");
$pengetahuan = pengetahuan("SELECT * FROM basis_pengetahuan WHERE id_pengetahuan = $id_pengetahuan")[0];

//cek tombol submit ditekan
if (isset($_POST["button"])) {
    //cek data berhasil ditambahkan atau tidak
    if (
        update_pengetahuan($_POST) > 0
    ) {
        echo " <script>
					alert('Data Basis Pengetahuan Berhasil Diubah');
					document.location.href ='../basis-pengetahuan.php';
			   </script>
			 ";
    } else {
        echo " <script>
					alert('Data Basis Pengetahuan Gagal Diubah');
			   </script>
			 ";
    }
}
                            ...
                            <h2 style="margin: 10px 0px 10px 10px; ">Sistem Pakar</h2>
                                <nav>
                                    <ol class="breadcrumb mb-4 " style="margin-left: 10px;">
                                        ...
                                        <li class="breadcrumb-item active"><a style="text-decoration: none; color: black;" href="../basis-pengetahuan.php">Data Basis Pengetahuan</a></li>
                                ...
                                <div class="card-body">
                                    <form action="" method="post">
                                        <div class="mb-3">
                                            ...
                                            <select name="nama_penyakit" id="nama_penyakit" class="form-control" required>
                                                <?php foreach ($result as $row) : ?>
                                                    <option value="<?php echo $row["kd_penyakit"]; ?>">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select name="nama_gejala" id="nama_gejala" class="form-control" required>
                                                <?php foreach ($result_gejala as $row_gejala) : ?>
                                                    <option value="<?php echo $row_gejala["kd_gejala"]; ?>">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="number" step="0.1" name="nilai_cf" id="nilai_cf" class="form-control" value="<?php echo $pengetahuan['nilai_cf'] ?>" required>
                                            <label>*Catatan : Untuk angka desimal gunakan tanda titik (.), Contoh 0.2</label>
                                        </div>
                                        <button type="submit" name="button" class="btn" style="background-color: #053038; color: white; font-weight: bold;">Simpan</button>
                                    </form>
                                </div>
                            </div>
                            </div>
