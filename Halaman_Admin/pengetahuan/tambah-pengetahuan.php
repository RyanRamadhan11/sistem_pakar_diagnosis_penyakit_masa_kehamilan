...
if (isset($_POST["button"])) {
    ...
    if (tambah_pengetahuan($_POST) > 0) {
        echo "
            <script>
            alert('Data Basis Pengetahuan Berhasil Ditambahkan');
        ...
        echo "
            <script>
            alert('Data Basis Pengetahuan Gagal Ditambahkan');
            document.location.href = '../basis-pengetahuan.php';
            </script>
        ";
    }
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-body">
                                    <form action="" method="post">
                                        <div class="mb-3">
                                            <input type="hidden" class="form-control" id="id_pengetahuan" name="id_pengetahuan" aria-describedby="id_pengetahuan">
                                        </div>
                                        <div class="mb-3">
                                        ...
                                        <button type="submit" name="button" class="btn" style="background-color: #053038; color: white; font-weight: bold;">Tambah</button>
                                    </form>
                                </div>
                            </div>
                            </div>
