...
require 'pengguna/controllers-pengguna.php';

//ambil data dari table gejala
$result = pengguna("SELECT * FROM pasien");
                                    ...
                                    <tbody>
                                        <?php foreach ($result as $row) : ?>
                                            <tr>
                                                ...
                                                <td><a href="pengguna/ubah-pengguna.php?id_pasien=<?php echo $row["id_pasien"]; ?>" 
                                                class="btn btn-warning btn-sm"><i class="fa-solid fa-pen-to-square"></i></a></td>
                                                <td><a href="pengguna/hapus-pengguna.php?id_pasien=<?php echo $row["id_pasien"]; ?>" 
                                                onclick="return confirm('Apakah Anda Yakin Ingin Menghapus Data Pasien Yang Dipilih?');" 
