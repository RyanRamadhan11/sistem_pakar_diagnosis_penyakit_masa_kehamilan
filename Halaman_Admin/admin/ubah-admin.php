...
$admin = admin("SELECT * FROM admin WHERE id_admin = $id_admin")[0];
                            ...
                            <h2 style="margin: 10px 0px 10px 10px; ">Sistem Pakar</h2>
                                <nav>
                                    <ol class="breadcrumb mb-4 " style="margin-left: 10px;">
                                        ...
                                        <li class="breadcrumb-item active"><a style="text-decoration: none; color: black;" href="../admin.php">Data Admin</a></li>
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-body">
                                    <form action="" method="post">
                                        <input type="hidden" class="form-control" value="<?php echo $admin["id_admin"]; ?>" id="id_admin" aria-describedby="id_admin" name="id_admin" readonly>
                                        <div class="mb-3">
                                            <label for="username" class="form-label">Username</label>
                                            <input type="text" class="form-control" value="<?php echo $admin["username"]; ?>" id="username" aria-describedby="username" name="username" required>
                                        </div>
                                        <div class="mb-3">
                                            <label for="password" class="form-label">Password</label>
                                            <input type="text" class="form-control" value="<?php echo $admin["password"]; ?>" id="password" aria-describedby="password" name="password" required>
                                        </div>
                                        <div class="mb-3">
                                            <label for="nama" class="form-label">Nama</label>
                                            <input type="text" class="form-control" value="<?php echo $admin["nama"]; ?>" id="nama" aria-describedby="nama" name="nama" required>
                                        </div>
