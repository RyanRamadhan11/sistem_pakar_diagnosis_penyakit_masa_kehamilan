...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 16 Jul 2023 pada 13.24
...
INSERT INTO `pasien` (`id_pasien`, `nama_pasien`, `jenis_kelamin`, `usia`, `email`, `alamat`) VALUES
(1, 'Nama Pasien 1', 'Perempuan', 23, 'pasien1@gmail.com', 'Karawang'),
(2, 'Nama Pasien 2', 'Perempuan', 21, 'pasien2@gmail.com', 'Jakarta'),
(3, 'Nama Pasien 3', 'Laki-laki', 34, 'pasien4@gmail.com', 'Karawang'),
(4, 'Yulita', 'Perempuan', 21, 'yulita@gmail.com', 'Karawang'),
(5, 'tes ryan 2', 'Laki-laki', 23, 'ryan@gmail.com', 'Karawang'),
(6, 'Nama Pasien 5', 'Perempuan', 21, 'pasien5@gmail.com', 'Cilamaya'),
(7, 'Riyanti', 'Perempuan', 24, 'riyanti@gmail.com', 'Pasir Jaya'),
(8, 'Sadiah', 'Perempuan', 21, 'saidah@gmail.com', 'Karawang');
...
--
ALTER TABLE `konsultasi`
  MODIFY `id_konsultasi` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
